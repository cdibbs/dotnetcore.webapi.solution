...
namespace API.Managers
{
    ...
    {
        public UserRoleManager(IRepository repo, IMapper mapper, IValidator<UserRole> validator, ILogger logger, IAuthManager<UserRole, long> auth, IUserRoleSpecificationProvider specs)

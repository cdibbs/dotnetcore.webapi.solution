    ...
    public class PopulationManager : IPopulationManager
    {
            ...
            SortSpecification[] sortSpecifications)
        {
            ...
            var res = Repo.Page(spec.And(Auth.GenerateFilterGet()),
                new PopulationSortFactory<V_Population>(sortSpecifications, this.SortSelectors),
                page, pageSize,
        ...
        public IViewModel<V_Population, string> Get(string username) => Get(Specs.PopulationByUsername<V_Population>(username));
